...
-- TODO The racket variable is empty when it gets called, and as such
-- it results in the exact same shell script as the Chez backend
-- (modulo one space). Simplify this away? But also consider this:
-- https://github.com/idris-lang/Idris2/pull/1992
